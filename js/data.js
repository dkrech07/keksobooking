...
(function() {
  ...
  // СПИСОК ОБЪЕКТОВ ДЛЯ ГЕНЕРАЦИИ ПРЕДЛОЖЕНИЙ;
  ...
  var similarAds = {}; // Обявление. Оъект в который будут записаны данные об одном предложении;
  ...
  var getFeatureList = function(arr) {
  ...
  var shuffleArray = function(array) { // Алгоритм Фишера-Йейтса работает, выбирая один случайный элемент для каждого исходного элемента массива, а затем исключая его из следующего розыгрыша;
