...
(function() {
  ...
  var featureCreateAll = function(featureCard) { // На вход нужно получить массив со списком удобств;
  ...
  var photoCreateAll = function(photoArr) { // На вход получаем массив со ссылками на фотографии;
  ...
  window.popupElement = function(i) { // В зависимости от i от 0 до 7, получаем соответствующий объект из созданного выше массива удобств;
    ...
    var newCard = window.mapActive.appendChild(popupCard); // Добавил карточку на карту;
    return newCard;
  }
